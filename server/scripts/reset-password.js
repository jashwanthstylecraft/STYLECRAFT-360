...
// Writes straight to Supabase, bypassing the API/auth entirely. For when
// both admins are locked out and there's no other way back in.
...
userService
  ...
  .then(() => console.log(`Password reset for ${username}.`))
  .catch((err) => {
